<div class="container">
    <div class="row">
        ...
        <div class="col-lg-7 col-md-12 py-n1" style="height: fit-content; overflow: hidden;">
            <div id="roomCarousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/rooms/IMG_11892.png" class="d-block w-100 rounded-3">
                    </div>
                    <div class="carousel-item">
                        <img src="images/rooms/IMG_39782.png" class="d-block w-100 rounded-3">
                    </div>
                    <div class="carousel-item">
                        <img src="images/rooms/IMG_65019.png" class="d-block w-100 rounded-3">
                    </div>
                </div>
            ...
            <div class="card mb-4 border-0 shadow-sm rounded-3">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="badge rounded-pill bg-light text-dark text-wrap me-1 mb-1">Room Heater</span>
                        <span class="badge rounded-pill bg-light text-dark text-wrap me-1 mb-1">Geyser</span>
                    </div>

                    <div class="mb-3">
                        <h6 class="mb-1">Guests</h6>
                        <span class="badge rounded-pill bg-light text-dark text-wrap me-1 mb-1">5 Adult</span>
                        <span class="badge rounded-pill bg-light text-dark text-wrap me-1 mb-1">3 Children</span>
                    </div>

                    <div class="mb-3">
                        <h6 class="mb-1">Area</h6>
                        <span class="badge rounded-pill bg-light text-dark text-wrap me-1 mb-1">25 sq.ft</span>
                    </div>

                    <a href="#" class="btn w-100 text-while custom-bg shadow-none mb-1">Book Now</a>
                </div>
            </div>
        </div>
