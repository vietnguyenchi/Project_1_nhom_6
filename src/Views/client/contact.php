<div class="my-5 px-4">
    ...
    <p class="text-center mt-3">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed maiores magnam atque <br> assumenda eligendi est
        quod
        aliquam? Ea, vel eligendi.
    </p>
</div>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 mb-5 px-4">
            <div class="bg-white rounded shadow p-4">
                ...
                <!-- Address -->
                <h5>Address</h5>
                <a href="https://maps.app.goo.gl/8oxQc9Jry3d5k7e79" target="_blank"
